...
@Test
public class ProcessingCall_reasonForNotBougth extends BaseTest {
    ...
    public void approve_test() throws SQLException {
        ...
        res.next();
        Assert.assertEquals(res.getInt("call_sequence_type"),3);
    ...
    void auth() throws SQLException, InterruptedException {
        for (int i = 0; i<10; i++) {
            ...
            Thread.sleep(1000);
            getDB().update("update terraleads_shipping.`call` set call_sequence_type = 3, order_id = " +
